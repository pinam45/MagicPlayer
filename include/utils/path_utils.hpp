...
[[nodiscard]] bool utf8_string_to_path(const std::string& str, std::filesystem::path& path);

// Convert a path to a generic utf8 string.
// return false on error, true on success
[[nodiscard]] bool path_to_generic_utf8_string(const std::filesystem::path& path, std::string& str);
